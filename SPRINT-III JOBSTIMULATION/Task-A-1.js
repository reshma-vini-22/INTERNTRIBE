//This To do List allows the user to list the task and add the list dynamiclly.
//It allows the user to edit their task dynamically.
//It allows the user to delete the task if it is not needed
//If the user completes their tasks it strike out the task completed.
